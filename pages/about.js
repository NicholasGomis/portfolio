    ...
    return (
        ...
        <div>
         ...
         <h3 className={styles.signature2} > Full Stack Software Engineer</h3>
           ...
           <p className={styles.textpara}> Recently, I got the opportunity to take part of the School of Code 14 weeks bootcamp.Throughout my time in the bootcamp, I learnt to work within a team, handle properly complex problems and have the right mindset to cope any challenges and of course new technologies and tools ⛺️ </p>
            <h2> 👨🏻‍💻  Tech Stacks </h2>
