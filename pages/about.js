...
export default function About(props) {
    ...
    return (
        ...
        <div>
            ...
            <p> Hello everyone! I am Nicholas. I was born and raised in Italy. Throughout my childhood I always have been fascinated with technology. During my afternoons, rather than playing football with friends, I used to buy broken computers to learn more about it's components and build my own machine. this new hobby led me to study Electrical and Electronic in High School.
            </p>
